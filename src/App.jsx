        ...
        <div className="bg-white rounded-2xl shadow-sm border border-cbe-100 overflow-hidden">
          ...
          <div className="p-6">
            <p className="text-sm text-gray-500 mb-6">
              Enter the FT number and the last 8 digits of the account number to
              verify a receipt.
            </p>
            ...
            {isValid && (
              <div className="mb-5 rounded-xl bg-cbe-50 border border-cbe-100 p-3">
                ...
                <p className="text-xs font-mono text-cbe-700 break-all leading-relaxed">
                  ...
                  <span className="text-cbe-600 font-semibold">{cleanFt}</span>
                  <span className="text-cbe-900 font-semibold">{cleanAcc}</span>
                </p>
              </div>
            )}
